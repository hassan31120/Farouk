                                                            ...
                                                            <div class="col-md-12 mb-4">
                                                                <div class="form-outline">
                                                                    ...
                                                                    <input type="text" name="title" id="title"
                                                                        class="form-control form-control-lg formborderCSS" value="{{ $product->title }}" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-4">
                                                                <div class="form-outline">
                                                                    ...
                                                                    class="form-control form-control-lg formborderCSS">{{ $product->description }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-12 mb-4">
                                                                <div class="form-outline">
                                                                    ...
                                                                    <input type="text" name="link" id="link"
                                                                        class="form-control form-control-lg formborderCSS" value="{{ $product->link }}" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group mx-sm-3 mb-2">
                                                                    ...
                                                                    <select name="cat_id" id="cat_id" class="form-control form-control-lg formborderCSS"
                                                                        ...
                                                                        @foreach ($cats as $cat)
                                                                            <option value="{{ $cat->id }}" {{isset($product) ? $product->cat_id == $cat->id ? 'selected' : '' : old('cat_id')}}>
                                                                                {{ $cat->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
